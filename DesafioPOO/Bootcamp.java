...
public class Bootcamp {
	...
	public Bootcamp(String nome, String descricao, Conteudo cursos, Conteudo mentorias) {
		this.nome = nome;
		this.descricao = descricao;
		List<Conteudo> listaConteudos = new ArrayList<>();
		listaConteudos.add(cursos);
		listaConteudos.add(mentorias);
		this.conteudos.addAll(listaConteudos);
	}
